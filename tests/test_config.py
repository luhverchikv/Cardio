...
class TestConfigErrors:
    ...
    def test_missing_bot_token_raises(self, monkeypatch):
        """Отсутствие BOT_TOKEN вызывает ошибку (environs требует обязательные поля)"""
        # Очищаем только BOT_TOKEN
        ...
        # environs выбрасывает ошибку для обязательных полей без дефолта
